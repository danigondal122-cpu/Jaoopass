            ...
            <div class="col-lg-12 pad-0">
              <div class="col-lg-7 cls_lefttextin">
                <div class="cls_lefttext">
                  <a href="<?php echo e(url('/')); ?>" style="display: block;width: 100%"><img style="width: 80px;margin:2px 0;height: 80px !important;" src="<?php echo e($logo_url); ?>"></a>
...
<?php echo $__env->make('template_footeronly', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/user/signup_company.blade.php ENDPATH**/ ?>
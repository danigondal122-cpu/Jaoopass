<header>
  <div class="fixed-header" id=header>
    <div class="container">
      ...
      <a href="<?php echo e(url('/')); ?>"  class="pull-left logo-link"><img style="width:80px;background-color: #fff;" src="<?php echo e($logo_url); ?>"></a>
      ...
      <div class="pull-right">
        <ul class="header-right-link">
          ...
          <div class="pull-right">
            <?php if(!Auth::user()): ?>
            <div class="become-driver"><a href="" class="btn btn--primary" >Cardload</a>
              <?php endif; ?>
            </div>
...
<?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/common/header.blade.php ENDPATH**/ ?>
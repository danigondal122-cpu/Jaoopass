<?php $__env->startSection('main'); ?>
    ...
    <div class="content-wrapper" ng-controller="company_management">
        ...
        <section class="content-header">
            <h1>
                <?php echo e(__('messages.admin.manage_company_page.title')); ?>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> <?php echo e(__('messages.admin.manage_company_page.title')); ?></li>
            </ol>
        </section>
                        ...
                        <div class="box-header">
                            ...
                            <?php if(Auth::guard('admin')->user()->can('create_company')): ?>
                                <div style="float:right;"><a class="btn btn-success"
                                        href="<?php echo e(url('admin/add_company')); ?>"><?php echo e(__('messages.admin.manage_company_page.add_company')); ?></a></div>
                            <?php endif; ?>
                        </div>
                        <!-- /.box-header -->
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/company/view.blade.php ENDPATH**/ ?>
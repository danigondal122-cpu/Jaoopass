...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo e(__('messages.admin.manage_admin_page.edit_admin_user')); ?>

      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/dashboard')); ?>"><i class="fa fa-dashboard"></i>  <?php echo e(__('messages.admin.home')); ?></a></li>
        <li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/admin_user')); ?>">   <?php echo e(__('messages.admin.manage_admin_page.admin_users')); ?></a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">      <?php echo e(__('messages.admin.manage_admin_page.edit_admin_user_form')); ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <span class="text-danger">(*)<?php echo e(__('messages.admin.fields_are_mandatory')); ?></span>
                <div class="form-group">
                  <label for="input_username" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_admin_page.form.username')); ?><em class="text-danger">*</em></label>
                ...
                <div class="form-group">
                  <label for="input_email" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_admin_page.form.email')); ?><em class="text-danger">*</em></label>
                ...
                <div class="form-group">
                  <label for="input_password" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_admin_page.form.password')); ?></label>
                ...
                <div class="form-group">
                  <label for="input_country_code" class="col-sm-3 control-label">
                    <?php echo e(__('messages.admin.manage_admin_page.form.country_code')); ?>  <em class="text-danger">*</em>
                  </label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_mobile_number" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_admin_page.form.mobile_number')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_role" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_admin_page.form.role')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_status" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_admin_page.form.status')); ?><em class="text-danger">*</em></label>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/admin_users/edit.blade.php ENDPATH**/ ?>
<?php $__env->startSection('main'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <?php echo e(__('messages.admin.manage_additional_reasons.title')); ?>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> <?php echo e(__('messages.admin.manage_additional_reasons.title')); ?></li>
            </ol>
        </section>
        <!-- Main content -->
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div style="float:right;"><a class="btn btn-success"
                                    href="<?php echo e(url('admin/add-additional-reason')); ?>"><?php echo e(__('messages.admin.manage_additional_reasons.add_additional_reason')); ?></a></div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/toll_reason/view.blade.php ENDPATH**/ ?>
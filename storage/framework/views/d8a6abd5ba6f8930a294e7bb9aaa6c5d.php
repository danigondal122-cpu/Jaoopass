<?php $__env->startSection('main'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <?php echo e(__('messages.admin.locations.add_location')); ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"> <?php echo e(__('messages.admin.locations.add_title')); ?></h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        ...
                        <div class="box-body"
                            ng-init="formatted_coords=<?php echo e(json_encode(old('formatted_coords', []))); ?>;coordinates=[]">
                            ...
                            <div class="form-group">
                                <label for="input_name" class="col-sm-3 control-label">
                                    <?php echo e(__('messages.admin.locations.form.name')); ?><em class="text-danger">*</em></label>
                            ...
                            <div class="form-group">
                                <label for="input_status" class="col-sm-3 control-label">       <?php echo e(__('messages.admin.locations.form.status')); ?><em
                                        class="text-danger">*</em></label>
                                <div class="col-md-7 col-sm-offset-1">
                                    <?php echo Form::select('status', ['Active' => 'Active', 'Inactive' => 'Inactive'], '', [
                                        'class' => 'form-control',
                                        'id' => 'input_status',
                                        'placeholder' => 'Select',
                                    ]); ?>
                        ...
                        <div class="box-footer text-center">
                            <button type="submit" class="btn btn-info" name="submit" value="submit">
                              <?php echo e(__('messages.admin.submit')); ?> 
                            </button>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/locations/add.blade.php ENDPATH**/ ?>
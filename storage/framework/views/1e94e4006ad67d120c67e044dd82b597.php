<?php $__env->startSection('main'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <?php echo e(__('messages.admin.manage_static_pages.title')); ?>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> <?php echo e(__('messages.admin.manage_static_pages.static_page')); ?></li>
            </ol>
        </section>
                        ...
                        <div class="box-header">
                            ...
                            <?php if(auth()->user()->can('create_static_page')): ?>
                                <div style="float:right;"><a class="btn btn-success"
                                        href="<?php echo e(url('admin/add_page')); ?>"><?php echo e(__('messages.admin.manage_static_pages.add_page')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                        <!-- /.box-header -->
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/pages/view.blade.php ENDPATH**/ ?>
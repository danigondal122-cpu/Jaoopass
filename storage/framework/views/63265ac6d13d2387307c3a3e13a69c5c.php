...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo e(__('messages.admin.manage_wallet_and_promo.wallet')); ?></li>
    </ol>
  </section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <div style="float:right;"><a class="btn btn-success" href="<?php echo e(route('add_wallet',['user_type' => $user_type])); ?>"><?php echo e(__('messages.admin.manage_wallet_and_promo.add_wallet')); ?> </a></div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/wallet/index.blade.php ENDPATH**/ ?>
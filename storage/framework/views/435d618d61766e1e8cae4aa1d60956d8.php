...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/barcode')); ?>">Barcode Management</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <form method="POST" action="<?php echo e(route('barcode.store')); ?>" class="form-horizontal">
                        <?php echo csrf_field(); ?>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-offset-1">
                                    ...
                                    <span class="text-danger"><?php echo e($errors->first('advance_amount')); ?></span>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/qr/create.blade.php ENDPATH**/ ?>
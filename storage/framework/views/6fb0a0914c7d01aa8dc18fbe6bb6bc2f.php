...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" ng-controller='pages'>
    ...
    <section class="content-header" >
      <h1>
        <?php echo e(__('messages.admin.manage_static_pages.edit_page')); ?>

      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/dashboard')); ?>"><i class="fa fa-dashboard"></i>   <?php echo e(__('messages.admin.home')); ?></a></li>
        <li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/pages')); ?>">      <?php echo e(__('messages.admin.manage_static_pages.page')); ?></a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">      <?php echo e(__('messages.admin.manage_static_pages.edit_page_form')); ?></h3>
            </div>
            ...
            <?php echo Form::open(['url' => 'admin/edit_page/'.$result->id, 'class' => 'form-horizontal']); ?>
              ...
              <span class="text-danger">(*)<?php echo e(__('messages.admin.fields_are_mandatory')); ?></span>
                <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label">      <?php echo e(__('messages.admin.manage_static_pages.form.name')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                    <?php echo Form::text('name', $result->name, ['class' => 'form-control', 'id' => 'input_name', 'placeholder' => __('messages.admin.manage_static_pages.form.name')]); ?>

                    <span class="text-danger"><?php echo e($errors->first('name')); ?></span>
                  </div>
                </div>
                <div class="form-group">
                  <label for="input_content" class="col-sm-3 control-label">      <?php echo e(__('messages.admin.manage_static_pages.form.content')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_footer" class="col-sm-3 control-label">  <?php echo e(__('messages.admin.manage_static_pages.form.footer')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_status" class="col-sm-3 control-label">  <?php echo e(__('messages.admin.manage_static_pages.form.status')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                 ...
                 <div class="panel" ng-init="translations = <?php echo e(json_encode(old('translations') ?: $result->translations)); ?>; removed_translations =  []; errors = <?php echo e(json_encode($errors->getMessages())); ?>; result_translations = <?php echo e(json_encode($result->translations)); ?>" ng-cloak>
                  <div class="panel-header">
                    <h4 class="box-title text-center"> <?php echo e(__('messages.admin.manage_static_pages.translations')); ?> </h4>
                  </div>
                  <div class="panel-body" ng-init="languages = <?php echo e(json_encode($languages)); ?>">
                    ...
                    <div class="row" ng-repeat="translation in translations">
                      ...
                      <div class="form-group">
                        <label for="input_language_{{$index}}" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_static_pages.form.language')); ?><em class="text-danger">*</em></label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <label for="input_name_{{$index}}" class="col-sm-3 control-label">  <?php echo e(__('messages.admin.manage_static_pages.form.name')); ?><em class="text-danger">*</em></label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group"  ng-init="multiple_editors($index)">
                        <label for="input_content_{{$index}}" class="col-sm-3 control-label">  <?php echo e(__('messages.admin.manage_static_pages.form.content')); ?><em class="text-danger">*</em></label>
                        <div class="col-sm-9">
                    ...
                    <div class="row" ng-show="(translations | checkActiveTranslation: languages).length <  <?php echo e(count($languages) - 1); ?>">
                      <div class="col-sm-10 col-sm-offset-1 text-center">
                        <button type="button" class="btn btn-info" ng-click="translations.push({locale:''});" >
                          <i class="fa fa-plus"></i> <?php echo e(__('messages.admin.manage_static_pages.add_translation')); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/pages/edit.blade.php ENDPATH**/ ?>
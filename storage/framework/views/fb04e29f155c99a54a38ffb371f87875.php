<aside class="main-sidebar">
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<?php endif; ?>
			<?php if(@$user->can('manage_admin')): ?>
			<li class="treeview <?php echo e((Route::current()->uri() == 'admin/barcodes/create' || Route::current()->uri() == 'admin/barcodes') ? 'active' : ''); ?>">
				<a href="#">
					<i class="fa fa-user-plus"></i> <span>Bar Codes</span> <i class="fa fa-angle-left pull-right"></i>
				</a>
				<ul class="treeview-menu">
					<li class="<?php echo e((Route::current()->uri() == 'admin/barcodes/create') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/barcodes/create')); ?>"><i class="fa fa-circle-o"></i><span>Create BarCodes</span></a></li>
					<li class="<?php echo e((Route::current()->uri() == 'admin/barcodes') ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/barcodes')); ?>"><i class="fa fa-circle-o"></i><span>View BarCodes</span></a></li>
				</ul>
			</li>
			<?php endif; ?>
...
<?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/common/navigation.blade.php ENDPATH**/ ?>
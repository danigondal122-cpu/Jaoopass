...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <?php $page = isset($result) ?  __('messages.admin.edit')  :  __('messages.admin.add') ; ?>
      <h1>
         <?php echo $page; ?> <?php echo e(__('messages.admin.manage_documents_page.add_documents')); ?> 
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(__('messages.admin.home')); ?> </a></li>
        <li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/documents')); ?>"><?php echo e(__('messages.admin.manage_documents_page.title')); ?> </a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo e(__('messages.admin.manage_documents_page.add_documents_form',['add'=>$page])); ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo Form::open(['url' => 'admin/add_document', 'class' => 'form-horizontal']); ?>
              ...
              <span class="text-danger">(*)<?php echo e(__('messages.admin.fields_are_mandatory')); ?></span>
               <div class="form-group">
                  <label for="input_language" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_documents_page.form.language')); ?><em class="text-danger">*</em></label>
                ...
                <div class="form-group">
                  <label for="input_status" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_documents_page.form.document_for')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_name" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_documents_page.form.document_name')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_code" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_documents_page.form.country')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_suggested" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_documents_page.form.expire_on_date')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
                ...
                <div class="form-group">
                  <label for="input_status" class="col-sm-3 control-label"><?php echo e(__('messages.admin.manage_documents_page.form.status')); ?><em class="text-danger">*</em></label>
                  <div class="col-md-7 col-sm-offset-1">
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/documents/add.blade.php ENDPATH**/ ?>
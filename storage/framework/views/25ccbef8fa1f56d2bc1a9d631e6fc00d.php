...
<div class="content-wrapper">
	<section class="content-header">
		<h1> <?php echo e(__('messages.admin.site_setting.title')); ?> </h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo e(url(LOGIN_USER_TYPE.'/dashboard')); ?>"><i class="fa fa-dashboard"></i>  <?php echo e(__('messages.admin.home')); ?></a></li>
			<li><a href="#"><?php echo e(__('messages.admin.site_setting.title')); ?> </a></li>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title"><?php echo e(__('messages.admin.site_setting.site_settings_form')); ?></h3>
					</div>
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="input_site_name" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.site_name')); ?><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('site_name', site_settings('site_name'), ['class' => 'form-control', 'id' => 'input_site_name', 'placeholder' => __('messages.admin.site_setting.form.site_name')]); ?>

								<span class="text-danger"><?php echo e($errors->first('site_name')); ?></span>
							</div>
						</div>
						<div class="form-group">
							<label for="input_site_name" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.version')); ?></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('version', site_settings('version'), ['class' => 'form-control', 'id' => 'input_version', 'placeholder' => __('messages.admin.site_setting.form.version')]); ?>

								<span class="text-danger"><?php echo e($errors->first('version')); ?></span>
							</div>
						</div>
						<div class="form-group">
							<label for="input_logo" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.header_logo')); ?></label>
							<div class="col-md-7 col-sm-offset-1">
							<em>Size: 140x80</em>
						...
						<div class="form-group">
							<label for="input_logo" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.header_white_logo')); ?></label>
							<div class="col-md-7 col-sm-offset-1">
							<em>Size: 140x80</em>
						...
						<div class="form-group">
							<label for="input_favicon" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.favicon')); ?></label>
							<div class="col-md-7 col-sm-offset-1">
							<em>Size: 16x16</em>
						...
						<div class="form-group">
							<label for="input_timezone" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.timezones')); ?></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::select('timezone', $timezones,site_settings('timezone'), ['class' => 'form-control', 'id' => 'input_timezone']); ?>
						...
						<div class="form-group">
							<label for="input_default_currency" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.default_currency')); ?></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_payment_currency" class="col-sm-3 control-label">
								<?php echo e(__('messages.admin.site_setting.form.payment_currency')); ?>

								<br>
								<span style="font-size: 12px;">
									<?php echo e(__('messages.admin.site_setting.note')); ?>
						...
						<div class="form-group">
							<label for="input_trip_default_paymode" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.trip_default_payment_method')); ?></label>
						...
						<div class="form-group">
							<label for="input_site_name" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.driver_kilometer')); ?></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_site_name" class="col-sm-3 control-label">
								<?php echo e(__('messages.admin.site_setting.form.pickup_kilometer')); ?> <br>
								<small>(*<?php echo e(__('messages.admin.site_setting.pool')); ?>)</small>
							</label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_site_name" class="col-sm-3 control-label">
								<?php echo e(__('messages.admin.site_setting.form.drop_kilometer')); ?></br>
								<small>(* <?php echo e(__('messages.admin.site_setting.pool')); ?>)</small>
							</label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_site_name" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.head_code')); ?></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_default_language" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.default_language')); ?></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_admin_country_code" class="col-sm-3 control-label">
								<?php echo e(__('messages.admin.site_setting.form.country_code')); ?> <em class="text-danger">*</em>
							</label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_mobile_number" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.manual_booking_contact_number')); ?> <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_heat_map" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.heat_map')); ?> <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_heat_map_hours" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.heat_map_hours')); ?> <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
					...
					<!--	<div class="form-group">
						...
						<div class="form-group">
							<label for="input_site_name" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.otp_verification')); ?>   <i id="interval-tooltip" data-toggle="tooltip" data-html="true"  class="glyphicon  glyphicon-info-sign" title="This otp for phone number verification on when you create an account"></i>
							</label>
							<div class="col-md-7 col-sm-offset-1" style="padding-top: 7px;margin-bottom: 0;">
								<label class="switch">
						...
						<div class="form-group">
							<label for="input_site_name" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.covid_feature')); ?></label>
							<div class="col-md-7 col-sm-offset-1" style="padding-top: 7px;margin-bottom: 0;">
								<label class="switch">
						...
						<div class="form-group">
							<label for="driver_request_seconds" class="col-sm-3 control-label">
								<?php echo e(__('messages.admin.site_setting.form.driver_request_seconds')); ?><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_mobile_number" class="col-sm-3 control-label">	<?php echo e(__('messages.admin.site_setting.form.driver_request_limit')); ?><i id="interval-tooltip" data-toggle="tooltip" data-html="true"  class="glyphicon  glyphicon-info-sign" title="This is the maximum driver limit while sending the trip request."></i><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('driver_request_limit', old('driver_request_limit',site_settings('driver_request_limit')), ['class' => 'form-control', 'id' => 'input_head_code', 'placeholder' => __('messages.admin.site_setting.form.driver_request_limit')]); ?>

								<span class="text-danger"><?php echo e($errors->first('driver_request_limit')); ?></span>
							</div>
						</div>
							<div class="form-group">
							<label for="input_mobile_number" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.pay_to_admin_driver_limit')); ?></i><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_mobile_number" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.copyright_year')); ?><em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('copyright_year', old('copyright_year',site_settings('copyright_year')), ['class' => 'form-control', 'id' => 'input_head_code', 'placeholder' => __('messages.admin.site_setting.form.copyright_year')]); ?>
						...
						<div class="form-group">
							<label for="input_mobile_number" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.copyright_url')); ?> <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
						...
						<div class="form-group">
							<label for="input_mobile_number" class="col-sm-3 control-label"><?php echo e(__('messages.admin.site_setting.form.copyright_name')); ?> <em class="text-danger">*</em></label>
							<div class="col-md-7 col-sm-offset-1">
								<?php echo Form::text('copyright_name', old('copyright_name',site_settings('copyright_name')), ['class' => 'form-control', 'id' => 'input_head_code', 'placeholder' => __('messages.admin.site_setting.form.copyright_name')]); ?>
					...
					<div class="box-footer text-center">
						...
						<button type="reset" class="btn btn-default" name="cancel" value="cancel"><?php echo e(__('messages.admin.cancel')); ?></button>
					</div>
					<?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fdeamvhp/jaoopass.com/resources/views/admin/site_settings.blade.php ENDPATH**/ ?>
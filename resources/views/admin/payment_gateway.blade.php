    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ url(LOGIN_USER_TYPE . '/payment_gateway') }}"> {{__('messages.admin.payment_gateway.title')}}</a>
                </li>
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <ul class="nav nav-pills nav-justified" style="margin-top:20px">
                                <li class="active"><a data-toggle="tab" href="#home">{{__('messages.admin.payment_gateway.tabs.paypal')}}  @if( payment_gateway('is_enabled', 'Paypal') == '1') <span class="badge">Active</span> @endif</a></li>
                                <li><a data-toggle="tab" href="#menu1">{{__('messages.admin.payment_gateway.tabs.stripe')}} @if(payment_gateway('is_enabled', 'Stripe') == '1') <span class="badge">Active</span> @endif </a></li>
                                <li><a data-toggle="tab" href="#menu2">{{__('messages.admin.payment_gateway.tabs.paytm')}}  @if(payment_gateway('is_enabled', 'Paytm') == '1') <span class="badge">Active</span> @endif</a></li>
                                <li><a data-toggle="tab" href="#menu3">{{__('messages.admin.payment_gateway.tabs.razorpay')}} @if(payment_gateway('is_enabled', 'Razorpay') == '1') <span class="badge">Active</span> @endif</a></li>
                                <li><a data-toggle="tab" href="#menu4">{{__('messages.admin.payment_gateway.tabs.flutterwave')}} @if(payment_gateway('is_enabled', 'Flutterwave') == '1') <span class="badge">Active</span> @endif</a></li>
                                <li><a data-toggle="tab" href="#menu5">{{__('messages.admin.payment_gateway.tabs.redsys')}} @if(payment_gateway('is_enabled', 'Redsys') == '1') <span class="badge">Active</span> @endif</a></li>
                                <li><a data-toggle="tab" href="#menu6">{{__('messages.admin.payment_gateway.tabs.braintree')}} @if(payment_gateway('is_enabled', 'Braintree') == '1') <span class="badge">Active</span> @endif</a></li>
                                <li><a data-toggle="tab" href="#menu7">{{__('messages.admin.payment_gateway.tabs.payout_methods')}}</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row" style="padding:10px">
                                        <div class="col-md-6">
                                            <div class="form-group"
                                                ...
                                                <label for="input_paypal_enabled" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.is_paypal_enabled')}} <em class="text-danger">*</em> </label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_paypal_mode" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.paypal_mode')}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_paypal_id" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.paypal_id')}} <em
                                                        ng-show="paypal_enabled == '1'" class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_paypal_client" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.paypal_client_id')}}
                                                    <em ng-show="paypal_enabled == '1'" class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_paypal_secret" class="col-sm-3 control-label"> {{__('messages.admin.payment_gateway.form.paypal_secret')}}
                                                    <em ng-show="paypal_enabled == '1'" class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="accessToken" class="col-sm-3 control-label"> {{__('messages.admin.payment_gateway.form.paypal_access_token')}}
                                                    <em ng-show="paypal_enabled == '1'" class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                ...
                                <div id="menu1" class="tab-pane fade">
                                    <div class="row" style="padding:10px">
                                        <div class="col-md-6">
                                            <div class="form-group" ng-init="stripe_enabled={{ old('stripe_enabled', payment_gateway('is_enabled', 'Stripe')) }}">
                                                <label for="input_stripe_enabled" class="col-sm-3 control-label"> {{__('messages.admin.payment_gateway.form.is_stripe_enabled')}}<em class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_stripe_publish_key" class="col-sm-3 control-label">
                                                    {{__('messages.admin.payment_gateway.form.stripe_key')}} <em ng-show="stripe_enabled == '1'"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_stripe_secret_key" class="col-sm-3 control-label">
                                                    {{__('messages.admin.payment_gateway.form.stripe_secret')}} <em ng-show="stripe_enabled == '1'"
                                                        class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                    ...
                                    <div class="row" style="padding:10px">
                                        <div class="col-md-6">
                                            <div class="form-group"
                                                ...
                                                <label for="input_paytm_enabled" class="col-sm-3 control-label">    {{__('messages.admin.payment_gateway.form.is_paytm_enabled')}}<em class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" >
                                                <label for="input_paytm_mode" class="col-sm-3 control-label"> {{__('messages.admin.payment_gateway.form.paytm_mode')}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_paytm_id" class="col-sm-3 control-label"> {{__('messages.admin.payment_gateway.form.paytm_merchant_id')}} <em ng-show="paytm_enabled == '1'"
                                                        class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_paytm_key" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.paytm_merchant_key')}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_paytm_website" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.paytm_merchant_website')}} <em ng-show="paytm_enabled == '1'"
                                                        class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_paytm_channel" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.paytm_merchant_channel')}}  <em ng-show="paytm_enabled == '1'"
                                                        class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_paytm_type" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.paytm_industry_type')}}<em ng-show="paytm_enabled == '1'"
                                                        class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                    ...
                                    <div class="row" style="padding:10px">
                                        <div class="col-md-6">
                                            <div class="form-group"
                                                ...
                                                <label for="input_razorpay_enabled" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.is_razorpay_enabled')}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_razorpay_mode" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.razorpay_mode')}} <em ng-show="razorpay_enabled == '1'" class="text-danger">*</em>
                                                </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                                    {!! Form::select(
                                                        'razorpay_mode',
                                    ...
                                    <div class="row" style="padding:10px">
                                        <div class="col-md-6">
                                            <div class="form-group"
                                                ...
                                                <label for="input_flutterwave_enabled" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.is_flutterwave_enabled')}} <em class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                                    {!! Form::select(
                                                        'flutterwave_enabled',
                                                        ['0' => 'No', '1' => 'Yes'],
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_flutterwave_publish_key" class="col-sm-3 control-label">
                                                    {{__('messages.admin.payment_gateway.form.flutterwave_key')}} <em ng-show="flutterwave_enabled == '1'"
                                                        class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                                    {!! Form::text(
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_flutterwave_secret_key" class="col-sm-3 control-label">
                                                    {{__('messages.admin.payment_gateway.form.flutterwave_secret')}} <em ng-show="flutterwave_enabled == '1'"
                                                        class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                                    {!! Form::text(
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_flutterwave_hash_key" class="col-sm-3 control-label">
                                                    {{__('messages.admin.payment_gateway.form.flutterwave_hash')}}  <em ng-show="flutterwave_enabled == '1'"
                                                        class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                    ...
                                    <div class="row" style="padding:10px">
                                        <div class="col-md-6">
                                            <div class="form-group"
                                                ...
                                                <label for="input_redsys_enabled" class="col-sm-3 control-label">  {{__('messages.admin.payment_gateway.form.is_redsys_enabled')}}  <em class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_redsys_enviroment" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.redsys_mode')}} <em ng-show="redsys_enabled == '1'" class="text-danger">*</em>
                                                </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                                    {!! Form::select(
                                                        'redsys_enviroment',
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_redsys_merchant_code"
                                                    class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.redsys_merchant_mode')}} <em ng-show="redsys_enabled == '1'"
                                                        class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_redsys_key" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.redsys_key')}} 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_redsys_terminal" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.redsys_terminal')}} <em ng-show="redsys_enabled == '1'"
                                                        class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_redsys_url_notification"
                                                    class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.redsys_url_notification')}}<em ng-show="redsys_enabled == '1'"
                                                ...
                                                <div class="col-md-7 col-sm-offset-1">
                                                    {!! Form::text(
                                                        ...
                                                        ['class' => 'form-control', 'id' => '', 'placeholder' => __('messages.admin.payment_gateway.form.redsys_url_notification')],
                                                    ) !!}
                                                    <span
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_redsys_url_ok" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.redsys_url_ok')}} <em ng-show="redsys_enabled == '1'" class="text-danger">*</em>
                                                </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_redsys_url_ko" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.redsys_url_ko')}} <em ng-show="redsys_enabled == '1'" class="text-danger">*</em>
                                                </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_redsys_tradename" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.redsys_tradename')}}
                                                    <em ng-show="redsys_enabled == '1'" class="text-danger">*</em>
                                                </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                    ...
                                    <div class="row" style="padding:10px">
                                        <div class="col-md-6">
                                            <div class="form-group"
                                                ...
                                                <label for="input_bt_enabled" class="col-sm-3 control-label">{{__('messages.admin.payment_gateway.form.is_braintree_enabled')}}
                                                    <em class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                                    {!! Form::select(
                                                        'bt_enabled',
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_mode" class="col-sm-3 control-label"> {{__('messages.admin.payment_gateway.form.payment_mode')}} <em
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_merchant_id" class="col-sm-3 control-label"> {{__('messages.admin.payment_gateway.form.braintree_merchant_id')}}<em ng-show="bt_enabled == '1'" class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_bt_public" class="col-sm-3 control-label">   {{__('messages.admin.payment_gateway.form.braintree_public_key')}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="input_bt_private_key" class="col-sm-3 control-label">
                                                    {{__('messages.admin.payment_gateway.form.braintree_private_key')}} <em ng-show="bt_enabled == '1'"
                                                        class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                ...
                                <div id="menu7" class="tab-pane fade">
                                    <div class="row" style="padding:10px">
                                        <div class="col-md-6 hidden">
                                            <div class="form-group ">
                                                <label for="is_web_payment" class="col-sm-3 control-label">      {{__('messages.admin.payment_gateway.form.web_payment')}}
                                                    <em ng-show="bt_enabled == '1'" class="text-danger">*</em></label>
                                                <div class="col-md-7 col-sm-offset-1">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="input_payout_methods" class="col-sm-3 control-label"> {{__('messages.admin.payment_gateway.form.payout_methods')}}
                                                    <em class="text-danger">*</em> </label>
                                                <div class="col-md-7 col-sm-offset-1">
                                                    @foreach (PAYOUT_METHODS as $payout_method)
                                                        <div
                                                            ...
                                                            <input type="checkbox" name="payout_methods[]"
                                                                ...
                                                                ng-checked="{{ isPayoutEnabled($payout_method['key']) }}"> <label
